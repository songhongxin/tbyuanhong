...
/*
 * 
 * 用于将shopid - >  sellerid的映射TLongLongHashMapTLongLongHashMap,序列化成本地文件
 * 
 * 
 * author  by yuanhong.shx
 * */

public class ShopSelleridtoFile {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			while ((line = bf.readLine()) != null) {
				...
				long shopid = Long.parseLong(lineArr[0]);
				long sellerid = Long.parseLong(lineArr[1]);
		...
		FileOutputStream fout = new FileOutputStream("shop_seller_id_dim.ser");
